...
Rule('Bcat_binds_dtcpx', Bcat(top=None,bottom=None,nterm='u') + Axin(bcat=None, ck1a=ANY, gsk3=ANY, apc=ANY) % Apc(aa20=None) | \
     Bcat(top=1, bottom=None,nterm='u') % Axin(bcat=1, ck1a=ANY, gsk3=ANY, apc=ANY) % Apc(aa20=None),   kf_bcat_dtcpx, kr_bcat_dtcpx)
